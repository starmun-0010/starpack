...
AKASHIC_TOME_NBT = {
      ...
      "akashictome:data":{
         ...
         "engineerstools":{
            ...
            "tag":{
               "akashictome:displayName":{
                  "text":"Engineer's Tools"
               },
               "patchouli:book":"engineerstools:engineerstools_manual",
               "akashictome:is_morphing":1,
               "display":{
                  "Name":"{\"translate\":\"akashictome.sudo_name\",\"with\":[{\"color\":\"green\",\"text\":\"Engineer\\\\\\'s Tools\"}]}"
               }
            }
         },
         "pneumaticcraft":{
         ...
         "immersiverailroading":{
            ...
            "tag":{
               "akashictome:displayName":{
                  "text":"Immersive Railroading Manual"
               },
               "akashictome:is_morphing":1,
               "display":{
                  "Name":"{\"translate\":\"akashictome.sudo_name\",\"with\":[{\"color\":\"green\",\"text\":\"Immersive Railroading Manual\"}]}"
               }
            }
         },
         "mahoutsukai":{
